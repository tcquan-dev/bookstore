    ...
    <div class="modal-dialog">
        <div class="modal-content">
                    ...
                    <div class="card flex-row shadow-sm cursor-pointer align-items-center my-3"
                        ...
                        <label class="custom-radio mx-3 p-3">
                            <input id="address_id" type="radio" name="address_id" value="{{ $item->id }}"
                                {{ $item->id == $order->address_id ? 'checked' : '' }}>
                            <span class="checkmark"></span>
                        </label>
                    </div>
                @endforeach
                <div class="d-flex justify-content-center my-3">
                    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#addressForm">
                        Add new address
                    </button>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="order-address-btn"
