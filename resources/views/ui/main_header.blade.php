                ...
                <div class="container-fluid">
                    <div class="row g-0">
                        ...
                        <div class="col-md-4 border-start border-end">
                            <p class="fs-6 my-2 text-center">Summer sale discount off 50% off! <a class="text-decoration-underline" href="shop.html">Shop Now</a></p>
                        </div>
                        <div class="col-md-4">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <ul class="list-group mb-3">
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="d-flex">
                                                            <img class="img-thumbnail w-25" src="{{ isset($item->image_path) ? asset('storage/'. $item->image_path) : ''}} " alt="Book">
                                                            <a class="m-2" href="single-product.html">
                                                                <h5>{{ $item->title }}</h5>
                                                            </a>
                                                        </div>
                                                        <p class="text-primary text-end">{{ number_format($item->price) . ' VNĐ' }}</p>
                                                    </li>
                                                    @endforeach
                                                </ul>
                                                <div class="d-flex justify-content-around">
                                                    <a href="{{ url('carts') }}" class="btn btn-primary" type="submit">Xem
                                                        giỏ hàng</a>
                                                    <a href="checkout.html" class="btn btn-primary" type="submit">Thanh toán</a>
                                                </div>
                                                @else
                                                <img class="img-fluid w-50 mx-auto" src="https://cdni.iconscout.com/illustration/premium/thumb/empty-cart-7359557-6024626.png" alt="Cart">
                                    ...
                                    <li class="pe-3">
                                        <div class="dropdown">
                                            <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                @if ($user)
                                                <img class="avatar rounded-circle" src="{{ isset($user->profile->avatar) ? asset('storage/' . $user->profile->avatar) : '' }}" alt="Avatar">
                                                @else
                                            ...
                                            <ul class="dropdown-menu animate slide dropdown-menu-end shadow">
                                                ...
                                                @if ($user->role_id == 1)
                                                <li><a class="dropdown-item py-2" href="{{ route('backpack.dashboard') }}">Dashboard</a>
                                                </li>
                                                @endif
                                                <li><a class="dropdown-item py-2" href="{{ route('backpack.auth.logout') }}">Đăng xuất</a>
                                                </li>
                                                @else
                                                <li><a class="dropdown-item py-2" href="{{ route('backpack.auth.login') }}">Đăng nhập</a>
                                                </li>
                                                <li><a class="dropdown-item py-2" href="{{ route('backpack.auth.register') }}">Đăng ký</a>
                                                </li>
                                                @endif
                                            </ul>
                                        </div>
